...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/ttfancy/logGO/internal/genproto/ingest/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	IngestServiceIngestProcedure = "/ingest.v1.IngestService/Ingest"
)
...
// Ingest calls ingest.v1.IngestService.Ingest.
...
func (UnimplementedIngestServiceHandler) Ingest(context.Context, *connect.Request[v1.IngestRequest]) (*connect.Response[v1.IngestResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("ingest.v1.IngestService.Ingest is not implemented"))
}
